...
function MemberInfoBox() {
    return <Col
      className="red-box col-12 col-md-6 text-center mb-5 mb-md-0 "
    >
      <h2 className="mt-5 mb-5"></h2>
      <p>
        Your are currently signed up for
       <span className="number-of-classes-taken"><b></b></span> <span className='sentence-text-classes'></span> 
      </p>
      <div className="classes-taken"></div>
  

      <DevBtn styleClass='btn-red'>Log Out</DevBtn>
    </Col>
}
